...
KEYPOINTS_FILE = r'results\sm_airplane_keypoints.npz'
OUTPUT_DIR = r'results\visualizations_sm_airplane'
N_KEYPOINTS = 8
MAX_POINTS = 2048
...
keypoint = data['kpcd']
nfact = data['nfact']  # pcmax und pcmin pro Modell

# Keypoints zurück in Original-Koordinaten
for i in range(len(keypoint)):
    pcmax, pcmin = nfact[i]
    keypoint[i] = (keypoint[i] / 2.0 + 0.5) * (pcmax - pcmin) + pcmin
